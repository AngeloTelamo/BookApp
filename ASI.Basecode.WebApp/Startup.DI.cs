...
namespace ASI.Basecode.WebApp
{
    ...
    internal partial class StartupConfigurer
    {
        ...
        private void ConfigureOtherServices()
        {
            ...
            this._services.AddScoped<IBookMasterService, BookMasterService>();  //injecting Services
            ...
            this._services.AddScoped<IBookMasterRepository, BookMasterRepository>();
            this._services.AddScoped<IReviewRepository, ReviewRepository>();//injecting Repo
