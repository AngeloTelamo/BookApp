...
namespace ASI.Basecode.WebApp
{
    ...
    internal partial class StartupConfigurer
    {
        ...
        public StartupConfigurer(IConfiguration configuration)
        {
            ...
            _signingKey = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(token.SecretKey));
            this._tokenProviderOptions = TokenProviderOptionsFactory.Create(token, _signingKey);
        ...
        public void ConfigureApp(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(@"C:\Users\telam\OneDrive\Documents\GitHub\Admi\ASI.Basecode.WebApp\wwwroot", "books")),
                RequestPath = "/clients"
            });     
